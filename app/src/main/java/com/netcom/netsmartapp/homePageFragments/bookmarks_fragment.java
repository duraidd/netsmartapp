 ...
 * Use the {@link bookmarks_fragment#newInstance} factory method to
...
public class bookmarks_fragment extends Fragment {
    ...
    public static bookmarks_fragment newInstance(String param1, String param2) {
        bookmarks_fragment fragment = new bookmarks_fragment();
